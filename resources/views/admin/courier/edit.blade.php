              ...
              <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="email" name="sender_email"  value="{{$courier->sender_email}}" class="form-control @error('sender_email') is-invalid @enderror" id="exampleInputEmail1"
                                                   aria-describedby="emailHelp" placeholder="" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="email" name="receiver_email"  value="{{$courier->receiver_email}}" class="form-control @error('receiver_email') is-invalid @enderror" id="exampleInputEmail1"
                                               aria-describedby="emailHelp" placeholder="" required>
                                        <small id="emailHelp" class="form-text text-muted">Receiver name
                                        </small>
